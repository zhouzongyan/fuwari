...
published: 2023-09-07 17:36:58
categories: 前端
id: react-useReducer-basic
tags: 
  - react
---
# 08 useReducer基础用法
...
很简单，我们将`dispatch('xxx')`中的xxx由字符串改为obj，obj可以携带更多属性作为参数传给reducer。 比如之前对 "加"的命令 `dispatch('add')`，修改为 `dispatch({type:'add',param:2})`。 reducer可以通过action.type来区分是哪种命令、通过action.param来获取对应的参数。  
