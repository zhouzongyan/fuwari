...
```
需要注意如果vps有防火墙、安全组之类的，9993的端口也要对应给放行，否则可能不成功
...
```
![](https://github.com/zhouzongyan/picx-images-hosting/raw/master/20241029/image.3uuud2xrwm.png)
...
![](https://github.com/zhouzongyan/picx-images-hosting/raw/master/20241029/image.lvqgfbm9c.webp)

使用之前我是根本连不上家里的主机的，使用之后，直接就可以ping了

ping检测，可以看到我的ping很低了，平常可以ping时会跳80-90甚至非常高，不是很稳定。

![](https://github.com/zhouzongyan/picx-images-hosting/raw/master/20241029/image.6t74gl80ma.webp)
