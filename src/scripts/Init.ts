...
export default () => {
  ...
  console.log("%c🌻 程序：Astro  | 作者：ZhouZhou | Github：https://github.com/zhouzongyan/fuwari 🌻", "color:#fff; background: linear-gradient(270deg, #18d7d3, #68b7dd, #8695e6, #986fee); padding: 8px 15px; border-radius: 8px");
